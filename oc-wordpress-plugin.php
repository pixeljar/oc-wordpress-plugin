...
// Register an activation/deactivation hook to set up custom user role.
register_activation_hook( __FILE__, '\ocwp\Users::activation' );
register_deactivation_hook( __FILE__, '\ocwp\Users::deactivation' );
